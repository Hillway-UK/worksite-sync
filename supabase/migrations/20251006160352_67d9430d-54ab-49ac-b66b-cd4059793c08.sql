...
-- Drop ALL triggers that might be using these functions
...
DROP FUNCTION IF EXISTS ensure_usage_row(uuid) CASCADE;
DROP FUNCTION IF EXISTS enforce_and_increment_manager_limit() CASCADE;
DROP FUNCTION IF EXISTS enforce_and_increment_worker_limit() CASCADE;
...
-- Recreate the triggers with correct names
